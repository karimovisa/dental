...
const doctorsConfig: EntityConfig = {
  ...
  fields: [
    ...
    { name: "specialization", label: "Specialization", type: "text", placeholder: "Orthodontist" },
...
const servicesConfig: EntityConfig = {
  ...
  imageFields: [],
  fields: [
    { name: "title", label: "Title", type: "text", required: true, placeholder: "Teeth Whitening" },
...
const certificatesConfig: EntityConfig = {
  ...
  imageFields: ["image_url"],
  fields: [
    { name: "title", label: "Title", type: "text", placeholder: "ISO 9001 Certified" },
...
const beforeAfterConfig: EntityConfig = {
  ...
  fields: [
    { name: "caption", label: "Caption", type: "text", placeholder: "Smile makeover with veneers" },
...
const galleryConfig: EntityConfig = {
  ...
  imageFields: ["image_url"],
  fields: [
    { name: "caption", label: "Caption", type: "text", placeholder: "Reception area" },
