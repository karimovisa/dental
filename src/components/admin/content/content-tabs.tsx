...
const doctorsConfig: EntityConfig = {
  ...
  fields: [
    ...
    { name: "specialization", label: "Specialization (EN)", type: "text", placeholder: "Orthodontist" },
    { name: "specialization_uz", label: "Specialization (UZ)", type: "text", placeholder: "Ortodont" },
    ...
    { name: "bio", label: "Short bio (EN)", type: "textarea" },
    { name: "bio_uz", label: "Short bio (UZ)", type: "textarea" },
...
const servicesConfig: EntityConfig = {
  ...
  imageFields: [],
  fields: [
    { name: "title", label: "Title (EN)", type: "text", required: true, placeholder: "Teeth Whitening" },
    { name: "title_uz", label: "Title (UZ)", type: "text", placeholder: "Tishlarni oqartirish" },
    { name: "title_ru", label: "Title (RU)", type: "text", placeholder: "Отбеливание зубов" },
    { name: "description", label: "Description (EN)", type: "textarea" },
    { name: "description_uz", label: "Description (UZ)", type: "textarea" },
...
const certificatesConfig: EntityConfig = {
  ...
  imageFields: ["image_url"],
  fields: [
    { name: "title", label: "Title (EN)", type: "text", placeholder: "ISO 9001 Certified" },
    { name: "title_uz", label: "Title (UZ)", type: "text", placeholder: "ISO 9001 sertifikati" },
...
const beforeAfterConfig: EntityConfig = {
  ...
  fields: [
    { name: "caption", label: "Caption (EN)", type: "text", placeholder: "Smile makeover with veneers" },
    { name: "caption_uz", label: "Caption (UZ)", type: "text", placeholder: "Vinirlar bilan tabassum" },
...
const galleryConfig: EntityConfig = {
  ...
  imageFields: ["image_url"],
  fields: [
    { name: "caption", label: "Caption (EN)", type: "text", placeholder: "Reception area" },
    { name: "caption_uz", label: "Caption (UZ)", type: "text", placeholder: "Qabulxona" },
...
const faqsConfig: EntityConfig = {
  ...
  imageFields: [],
  fields: [
    { name: "question", label: "Question (EN)", type: "text", required: true, fullWidth: true },
    { name: "question_uz", label: "Question (UZ)", type: "text", fullWidth: true },
    { name: "question_ru", label: "Question (RU)", type: "text", fullWidth: true },
    { name: "answer", label: "Answer (EN)", type: "textarea", required: true },
    { name: "answer_uz", label: "Answer (UZ)", type: "textarea" },
